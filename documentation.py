...
"""
    ...
    def create_documentation_tab(self):
        ...
        copy_button = ttk.Button(arduino1_frame, text="Copy the Arduino Code ", command=self.copy_arduino_code,style="Copy.TButton")
        copy_button.pack(pady=10)
        style = ttk.Style()
        style.configure("Copy.TButton", foreground="black", background="green")
        ...
        • Press the boot button of ESP32 while pushing the code to ESP32.
